...
#SBATCH --gres=gpu:1
#SBATCH --output=%x_%j.out         # Output file: SA_baseline_[jobID].out in current directory
#SBATCH --error=%x_%j.err          # Error file: SA_baseline_[jobID].err in current directory
...
# Run with WandB integration - Using full dataset
python -u main.py \
